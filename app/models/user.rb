  ...
  def create_challenges(player)
    ...
    Challenge.create(
      [
        ...
        # UNDEAD
        # Revenant
        { computer: Player.where(code: "epic Revenant 1").first, rank: 1, requirement: "Death Knight,Vampire,Banshee,Skeleton Shieldbearer,Zombie Brute", epic_card: "Revenant" }.merge(attr_epic),
        { computer: Player.where(code: "epic Revenant 2").first, rank: 2, requirement: "Death Knight,Vampire,Banshee,Skeleton Shieldbearer,Zombie Brute", epic_card: "Revenant" }.merge(attr_epic),
        { computer: Player.where(code: "epic Revenant 3").first, rank: 3, requirement: "Death Knight,Vampire,Banshee,Skeleton Shieldbearer,Zombie Brute", epic_card: "Revenant" }.merge(attr_epic),
        { computer: Player.where(code: "epic Revenant 4").first, rank: 4, requirement: "Death Knight,Vampire,Banshee,Skeleton Shieldbearer,Zombie Brute", epic_card: "Revenant" }.merge(attr_epic),
        { computer: Player.where(code: "epic Revenant 5").first, rank: 5, requirement: "Death Knight,Vampire,Banshee,Skeleton Shieldbearer,Zombie Brute", epic_card: "Revenant" }.merge(attr_epic),
        # Death Weaver
        { computer: Player.where(code: "epic Death Weaver 1").first, rank: 1, requirement: "Mummy,Specter,Lich,Necromancer,Plague Doctor", epic_card: "Death Weaver" }.merge(attr_epic),
        { computer: Player.where(code: "epic Death Weaver 2").first, rank: 2, requirement: "Mummy,Specter,Lich,Necromancer,Plague Doctor", epic_card: "Death Weaver" }.merge(attr_epic),
        { computer: Player.where(code: "epic Death Weaver 3").first, rank: 3, requirement: "Mummy,Specter,Lich,Necromancer,Plague Doctor", epic_card: "Death Weaver" }.merge(attr_epic),
        { computer: Player.where(code: "epic Death Weaver 4").first, rank: 4, requirement: "Mummy,Specter,Lich,Necromancer,Plague Doctor", epic_card: "Death Weaver" }.merge(attr_epic),
        { computer: Player.where(code: "epic Death Weaver 5").first, rank: 5, requirement: "Mummy,Specter,Lich,Necromancer,Plague Doctor", epic_card: "Death Weaver" }.merge(attr_epic),
        # Bone Golem
        { computer: Player.where(code: "epic Bone Golem 1").first, rank: 1, requirement: "Death Knight,Death Priest,Bone Mender,Crypt Sentinel,Rotting Corpse", epic_card: "Bone Golem" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Golem 2").first, rank: 2, requirement: "Death Knight,Death Priest,Bone Mender,Crypt Sentinel,Rotting Corpse", epic_card: "Bone Golem" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Golem 3").first, rank: 3, requirement: "Death Knight,Death Priest,Bone Mender,Crypt Sentinel,Rotting Corpse", epic_card: "Bone Golem" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Golem 4").first, rank: 4, requirement: "Death Knight,Death Priest,Bone Mender,Crypt Sentinel,Rotting Corpse", epic_card: "Bone Golem" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Golem 5").first, rank: 5, requirement: "Death Knight,Death Priest,Bone Mender,Crypt Sentinel,Rotting Corpse", epic_card: "Bone Golem" }.merge(attr_epic),
        # Wight
        { computer: Player.where(code: "epic Wight 1").first, rank: 1, requirement: "Skeleton Warrior,Zombie,Ghoul,Crypt Sentinel,Mummy Guardian", epic_card: "Wight" }.merge(attr_epic),
        { computer: Player.where(code: "epic Wight 2").first, rank: 2, requirement: "Skeleton Warrior,Zombie,Ghoul,Crypt Sentinel,Mummy Guardian", epic_card: "Wight" }.merge(attr_epic),
        { computer: Player.where(code: "epic Wight 3").first, rank: 3, requirement: "Skeleton Warrior,Zombie,Ghoul,Crypt Sentinel,Mummy Guardian", epic_card: "Wight" }.merge(attr_epic),
        { computer: Player.where(code: "epic Wight 4").first, rank: 4, requirement: "Skeleton Warrior,Zombie,Ghoul,Crypt Sentinel,Mummy Guardian", epic_card: "Wight" }.merge(attr_epic),
        { computer: Player.where(code: "epic Wight 5").first, rank: 5, requirement: "Skeleton Warrior,Zombie,Ghoul,Crypt Sentinel,Mummy Guardian", epic_card: "Wight" }.merge(attr_epic),
        # Necrophage
        { computer: Player.where(code: "epic Necrophage 1").first, rank: 1, requirement: "Necromancer Acolyte,Bone Weaver,Mummy Guardian,Bone Dragon,Plague Doctor", epic_card: "Necrophage" }.merge(attr_epic),
        { computer: Player.where(code: "epic Necrophage 2").first, rank: 2, requirement: "Necromancer Acolyte,Bone Weaver,Mummy Guardian,Bone Dragon,Plague Doctor", epic_card: "Necrophage" }.merge(attr_epic),
        { computer: Player.where(code: "epic Necrophage 3").first, rank: 3, requirement: "Necromancer Acolyte,Bone Weaver,Mummy Guardian,Bone Dragon,Plague Doctor", epic_card: "Necrophage" }.merge(attr_epic),
        { computer: Player.where(code: "epic Necrophage 4").first, rank: 4, requirement: "Necromancer Acolyte,Bone Weaver,Mummy Guardian,Bone Dragon,Plague Doctor", epic_card: "Necrophage" }.merge(attr_epic),
        { computer: Player.where(code: "epic Necrophage 5").first, rank: 5, requirement: "Necromancer Acolyte,Bone Weaver,Mummy Guardian,Bone Dragon,Plague Doctor", epic_card: "Necrophage" }.merge(attr_epic),
        # Bone Dragon
        { computer: Player.where(code: "epic Bone Dragon 1").first, rank: 1, requirement: "Skeletal Archer,Wraith,Death Priest,Bone Mender,Skeleton Shieldbearer", epic_card: "Bone Dragon" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Dragon 2").first, rank: 2, requirement: "Skeletal Archer,Wraith,Death Priest,Bone Mender,Skeleton Shieldbearer", epic_card: "Bone Dragon" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Dragon 3").first, rank: 3, requirement: "Skeletal Archer,Wraith,Death Priest,Bone Mender,Skeleton Shieldbearer", epic_card: "Bone Dragon" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Dragon 4").first, rank: 4, requirement: "Skeletal Archer,Wraith,Death Priest,Bone Mender,Skeleton Shieldbearer", epic_card: "Bone Dragon" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Dragon 5").first, rank: 5, requirement: "Skeletal Archer,Wraith,Death Priest,Bone Mender,Skeleton Shieldbearer", epic_card: "Bone Dragon" }.merge(attr_epic),
        # Lich Healer
        { computer: Player.where(code: "epic Lich Healer 1").first, rank: 1, requirement: "Zombie Brute,Crypt Sentinel,Death Knight,Lich,Plague Doctor", epic_card: "Lich Healer" }.merge(attr_epic),
        { computer: Player.where(code: "epic Lich Healer 2").first, rank: 2, requirement: "Zombie Brute,Crypt Sentinel,Death Knight,Lich,Plague Doctor", epic_card: "Lich Healer" }.merge(attr_epic),
        { computer: Player.where(code: "epic Lich Healer 3").first, rank: 3, requirement: "Zombie Brute,Crypt Sentinel,Death Knight,Lich,Plague Doctor", epic_card: "Lich Healer" }.merge(attr_epic),
        ...
        { computer: Player.where(code: "epic Wight Juggernaut 3").first, rank: 3, requirement: "Skeleton Shieldbearer,Zombie Brute,Crypt Sentinel,Bone Weaver,Mummy", epic_card: "Wight Juggernaut" }.merge(attr_epic),
        ...
        # Spectral Guardian
        { computer: Player.where(code: "epic Spectral Guardian 1").first, rank: 1, requirement: "Ghoul,Graveyard Wisp,Banshee,Death Plaguebearer,Mummy Guardian", epic_card: "Spectral Guardian" }.merge(attr_epic),
        { computer: Player.where(code: "epic Spectral Guardian 2").first, rank: 2, requirement: "Ghoul,Graveyard Wisp,Banshee,Death Plaguebearer,Mummy Guardian", epic_card: "Spectral Guardian" }.merge(attr_epic),
        { computer: Player.where(code: "epic Spectral Guardian 3").first, rank: 3, requirement: "Ghoul,Graveyard Wisp,Banshee,Death Plaguebearer,Mummy Guardian", epic_card: "Spectral Guardian" }.merge(attr_epic),
        { computer: Player.where(code: "epic Spectral Guardian 4").first, rank: 4, requirement: "Ghoul,Graveyard Wisp,Banshee,Death Plaguebearer,Mummy Guardian", epic_card: "Spectral Guardian" }.merge(attr_epic),
        { computer: Player.where(code: "epic Spectral Guardian 5").first, rank: 5, requirement: "Ghoul,Graveyard Wisp,Banshee,Death Plaguebearer,Mummy Guardian", epic_card: "Spectral Guardian" }.merge(attr_epic),
        # Lich King
        ...
        { computer: Player.where(code: "epic Lich King 3").first, rank: 3, requirement: "Revenant,Death Weaver,Bone Golem,Lich Healer,Wight Juggernaut", epic_card: "Lich King" }.merge(attr_elite),
        { computer: Player.where(code: "epic Lich King 4").first, rank: 4, requirement: "Revenant,Death Weaver,Bone Golem,Lich Healer,Wight Juggernaut", epic_card: "Lich King" }.merge(attr_elite),
        { computer: Player.where(code: "epic Lich King 5").first, rank: 5, requirement: "Revenant,Death Weaver,Bone Golem,Lich Healer,Wight Juggernaut", epic_card: "Lich King" }.merge(attr_elite),
        # Grave Lord
        { computer: Player.where(code: "epic Grave Lord 1").first, rank: 1, requirement: "Wight,Necrophage,Bone Dragon,Crypt Keeper,Spectral Guardian", epic_card: "Grave Lord" }.merge(attr_elite),
        { computer: Player.where(code: "epic Grave Lord 2").first, rank: 2, requirement: "Wight,Necrophage,Bone Dragon,Crypt Keeper,Spectral Guardian", epic_card: "Grave Lord" }.merge(attr_elite),
        { computer: Player.where(code: "epic Grave Lord 3").first, rank: 3, requirement: "Wight,Necrophage,Bone Dragon,Crypt Keeper,Spectral Guardian", epic_card: "Grave Lord" }.merge(attr_elite),
        { computer: Player.where(code: "epic Grave Lord 4").first, rank: 4, requirement: "Wight,Necrophage,Bone Dragon,Crypt Keeper,Spectral Guardian", epic_card: "Grave Lord" }.merge(attr_elite),
        { computer: Player.where(code: "epic Grave Lord 5").first, rank: 5, requirement: "Wight,Necrophage,Bone Dragon,Crypt Keeper,Spectral Guardian", epic_card: "Grave Lord" }.merge(attr_elite)
      ]
    )
  end
end
