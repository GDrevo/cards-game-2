  ...
  def create_challenges(player)
    ...
    Challenge.create(
      [
        ...
        # UNDEAD
        # Revenant
        { computer: Player.where(code: "epic Revenant 1").first, rank: 1, requirement: "Swordsman,Axeman,Spearman,Shieldbearer,Brute", epic_card: "Revenant" }.merge(attr_epic),
        { computer: Player.where(code: "epic Revenant 2").first, rank: 2, requirement: "Swordsman,Axeman,Spearman,Shieldbearer,Brute", epic_card: "Revenant" }.merge(attr_epic),
        { computer: Player.where(code: "epic Revenant 3").first, rank: 3, requirement: "Swordsman,Axeman,Spearman,Shieldbearer,Brute", epic_card: "Revenant" }.merge(attr_epic),
        { computer: Player.where(code: "epic Revenant 4").first, rank: 4, requirement: "Swordsman,Axeman,Spearman,Shieldbearer,Brute", epic_card: "Revenant" }.merge(attr_epic),
        { computer: Player.where(code: "epic Revenant 5").first, rank: 5, requirement: "Swordsman,Axeman,Spearman,Shieldbearer,Brute", epic_card: "Revenant" }.merge(attr_epic),
        # Death Weaver
        { computer: Player.where(code: "epic Death Weaver 1").first, rank: 1, requirement: "Cavalry,Mage Apprentice,Marksman,Priestess,Cleric", epic_card: "Death Weaver" }.merge(attr_epic),
        { computer: Player.where(code: "epic Death Weaver 2").first, rank: 2, requirement: "Cavalry,Mage Apprentice,Marksman,Priestess,Cleric", epic_card: "Death Weaver" }.merge(attr_epic),
        { computer: Player.where(code: "epic Death Weaver 3").first, rank: 3, requirement: "Cavalry,Mage Apprentice,Marksman,Priestess,Cleric", epic_card: "Death Weaver" }.merge(attr_epic),
        { computer: Player.where(code: "epic Death Weaver 4").first, rank: 4, requirement: "Cavalry,Mage Apprentice,Marksman,Priestess,Cleric", epic_card: "Death Weaver" }.merge(attr_epic),
        { computer: Player.where(code: "epic Death Weaver 5").first, rank: 5, requirement: "Cavalry,Mage Apprentice,Marksman,Priestess,Cleric", epic_card: "Death Weaver" }.merge(attr_epic),
        # Bone Golem
        { computer: Player.where(code: "epic Bone Golem 1").first, rank: 1, requirement: "Swordsman,Alchemist,Herbalist,Guardian,Crossbowman", epic_card: "Bone Golem" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Golem 2").first, rank: 2, requirement: "Swordsman,Alchemist,Herbalist,Guardian,Crossbowman", epic_card: "Bone Golem" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Golem 3").first, rank: 3, requirement: "Swordsman,Alchemist,Herbalist,Guardian,Crossbowman", epic_card: "Bone Golem" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Golem 4").first, rank: 4, requirement: "Swordsman,Alchemist,Herbalist,Guardian,Crossbowman", epic_card: "Bone Golem" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Golem 5").first, rank: 5, requirement: "Swordsman,Alchemist,Herbalist,Guardian,Crossbowman", epic_card: "Bone Golem" }.merge(attr_epic),
        # Wight
        { computer: Player.where(code: "epic Wight 1").first, rank: 1, requirement: "Squire,Footman,Archer,Guardian,Crusader", epic_card: "Wight" }.merge(attr_epic),
        { computer: Player.where(code: "epic Wight 2").first, rank: 2, requirement: "Squire,Footman,Archer,Guardian,Crusader", epic_card: "Wight" }.merge(attr_epic),
        { computer: Player.where(code: "epic Wight 3").first, rank: 3, requirement: "Squire,Footman,Archer,Guardian,Crusader", epic_card: "Wight" }.merge(attr_epic),
        { computer: Player.where(code: "epic Wight 4").first, rank: 4, requirement: "Squire,Footman,Archer,Guardian,Crusader", epic_card: "Wight" }.merge(attr_epic),
        { computer: Player.where(code: "epic Wight 5").first, rank: 5, requirement: "Squire,Footman,Archer,Guardian,Crusader", epic_card: "Wight" }.merge(attr_epic),
        # Necrophage
        { computer: Player.where(code: "epic Necrophage 1").first, rank: 1, requirement: "Acolyte,Druid,Crusader,Commander,Cleric", epic_card: "Necrophage" }.merge(attr_epic),
        { computer: Player.where(code: "epic Necrophage 2").first, rank: 2, requirement: "Acolyte,Druid,Crusader,Commander,Cleric", epic_card: "Necrophage" }.merge(attr_epic),
        { computer: Player.where(code: "epic Necrophage 3").first, rank: 3, requirement: "Acolyte,Druid,Crusader,Commander,Cleric", epic_card: "Necrophage" }.merge(attr_epic),
        { computer: Player.where(code: "epic Necrophage 4").first, rank: 4, requirement: "Acolyte,Druid,Crusader,Commander,Cleric", epic_card: "Necrophage" }.merge(attr_epic),
        { computer: Player.where(code: "epic Necrophage 5").first, rank: 5, requirement: "Acolyte,Druid,Crusader,Commander,Cleric", epic_card: "Necrophage" }.merge(attr_epic),
        # Bone Dragon
        { computer: Player.where(code: "epic Bone Dragon 1").first, rank: 1, requirement: "Militia,Scout,Alchemist,Herbalist,Shieldbearer", epic_card: "Bone Dragon" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Dragon 2").first, rank: 2, requirement: "Militia,Scout,Alchemist,Herbalist,Shieldbearer", epic_card: "Bone Dragon" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Dragon 3").first, rank: 3, requirement: "Militia,Scout,Alchemist,Herbalist,Shieldbearer", epic_card: "Bone Dragon" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Dragon 4").first, rank: 4, requirement: "Militia,Scout,Alchemist,Herbalist,Shieldbearer", epic_card: "Bone Dragon" }.merge(attr_epic),
        { computer: Player.where(code: "epic Bone Dragon 5").first, rank: 5, requirement: "Militia,Scout,Alchemist,Herbalist,Shieldbearer", epic_card: "Bone Dragon" }.merge(attr_epic),
        # Lich Healer
        { computer: Player.where(code: "epic Lich Healer 1").first, rank: 1, requirement: "Brute,Guardian,Swordsman,Marksman,Cleric", epic_card: "Lich Healer" }.merge(attr_epic),
        { computer: Player.where(code: "epic Lich Healer 2").first, rank: 2, requirement: "Brute,Guardian,Swordsman,Marksman,Cleric", epic_card: "Lich Healer" }.merge(attr_epic),
        { computer: Player.where(code: "epic Lich Healer 3").first, rank: 3, requirement: "Brute,Guardian,Swordsman,Marksman,Cleric", epic_card: "Lich Healer" }.merge(attr_epic),
        { computer: Player.where(code: "epic Lich Healer 4").first, rank: 4, requirement: "Brute,Guardian,Swordsman,Marksman,Cleric", epic_card: "Lich Healer" }.merge(attr_epic),
        { computer: Player.where(code: "epic Lich Healer 5").first, rank: 5, requirement: "Brute,Guardian,Swordsman,Marksman,Cleric", epic_card: "Lich Healer" }.merge(attr_epic),
        # Crypt Keeper
        { computer: Player.where(code: "epic Crypt Keeper 1").first, rank: 1, requirement: "Axeman,Mage Apprentice,Priestess,Priest,Medic", epic_card: "Crypt Keeper" }.merge(attr_epic),
        { computer: Player.where(code: "epic Crypt Keeper 2").first, rank: 2, requirement: "Axeman,Mage Apprentice,Priestess,Priest,Medic", epic_card: "Crypt Keeper" }.merge(attr_epic),
        { computer: Player.where(code: "epic Crypt Keeper 3").first, rank: 3, requirement: "Axeman,Mage Apprentice,Priestess,Priest,Medic", epic_card: "Crypt Keeper" }.merge(attr_epic),
        { computer: Player.where(code: "epic Crypt Keeper 4").first, rank: 4, requirement: "Axeman,Mage Apprentice,Priestess,Priest,Medic", epic_card: "Crypt Keeper" }.merge(attr_epic),
        { computer: Player.where(code: "epic Crypt Keeper 5").first, rank: 5, requirement: "Axeman,Mage Apprentice,Priestess,Priest,Medic", epic_card: "Crypt Keeper" }.merge(attr_epic),
        # Wight JUGGERNAUT
        { computer: Player.where(code: "epic Wight Juggernaut 1").first, rank: 1, requirement: "Shieldbearer,Brute,Guardian,Druid,Cavalry", epic_card: "Wight Juggernaut" }.merge(attr_epic),
        { computer: Player.where(code: "epic Wight Juggernaut 2").first, rank: 2, requirement: "Shieldbearer,Brute,Guardian,Druid,Cavalry", epic_card: "Wight Juggernaut" }.merge(attr_epic),
        { computer: Player.where(code: "epic Wight Juggernaut 3").first, rank: 3, requirement: "Shieldbearer,Brute,Guardian,Druid,Cavalry", epic_card: "Wight Juggernaut" }.merge(attr_epic),
        { computer: Player.where(code: "epic Wight Juggernaut 4").first, rank: 4, requirement: "Shieldbearer,Brute,Guardian,Druid,Cavalry", epic_card: "Wight Juggernaut" }.merge(attr_epic),
        { computer: Player.where(code: "epic Wight Juggernaut 5").first, rank: 5, requirement: "Shieldbearer,Brute,Guardian,Druid,Cavalry", epic_card: "Wight Juggernaut" }.merge(attr_epic),
        # Spectral Guardian
        { computer: Player.where(code: "epic Spectral Guardian 1").first, rank: 1, requirement: "Archer,Medic,Spearman,Alchemist,Crusader", epic_card: "Spectral Guardian" }.merge(attr_epic),
        { computer: Player.where(code: "epic Spectral Guardian 2").first, rank: 2, requirement: "Archer,Medic,Spearman,Alchemist,Crusader", epic_card: "Spectral Guardian" }.merge(attr_epic),
        { computer: Player.where(code: "epic Spectral Guardian 3").first, rank: 3, requirement: "Archer,Medic,Spearman,Alchemist,Crusader", epic_card: "Spectral Guardian" }.merge(attr_epic),
        { computer: Player.where(code: "epic Spectral Guardian 4").first, rank: 4, requirement: "Archer,Medic,Spearman,Alchemist,Crusader", epic_card: "Spectral Guardian" }.merge(attr_epic),
        { computer: Player.where(code: "epic Spectral Guardian 5").first, rank: 5, requirement: "Archer,Medic,Spearman,Alchemist,Crusader", epic_card: "Spectral Guardian" }.merge(attr_epic),
        # Lich King
        { computer: Player.where(code: "epic Lich King 1").first, rank: 1, requirement: "Paladin,Berserker,Knight,High Priest,Juggernaut", epic_card: "Lich King" }.merge(attr_elite),
        { computer: Player.where(code: "epic Lich King 2").first, rank: 2, requirement: "Paladin,Berserker,Knight,High Priest,Juggernaut", epic_card: "Lich King" }.merge(attr_elite),
        { computer: Player.where(code: "epic Lich King 3").first, rank: 3, requirement: "Paladin,Berserker,Knight,High Priest,Juggernaut", epic_card: "Lich King" }.merge(attr_elite),
        { computer: Player.where(code: "epic Lich King 4").first, rank: 4, requirement: "Paladin,Berserker,Knight,High Priest,Juggernaut", epic_card: "Lich King" }.merge(attr_elite),
        { computer: Player.where(code: "epic Lich King 5").first, rank: 5, requirement: "Paladin,Berserker,Knight,High Priest,Juggernaut", epic_card: "Lich King" }.merge(attr_elite),
        # Grave Lord
        { computer: Player.where(code: "epic Grave Lord 1").first, rank: 1, requirement: "Mage,Captain,Commander,Battle Medic,Warden", epic_card: "Grave Lord" }.merge(attr_elite),
        { computer: Player.where(code: "epic Grave Lord 2").first, rank: 2, requirement: "Mage,Captain,Commander,Battle Medic,Warden", epic_card: "Grave Lord" }.merge(attr_elite),
        { computer: Player.where(code: "epic Grave Lord 3").first, rank: 3, requirement: "Mage,Captain,Commander,Battle Medic,Warden", epic_card: "Grave Lord" }.merge(attr_elite),
        { computer: Player.where(code: "epic Grave Lord 4").first, rank: 4, requirement: "Mage,Captain,Commander,Battle Medic,Warden", epic_card: "Grave Lord" }.merge(attr_elite),
        { computer: Player.where(code: "epic Grave Lord 5").first, rank: 5, requirement: "Mage,Captain,Commander,Battle Medic,Warden", epic_card: "Grave Lord" }.merge(attr_elite)
      ]
    )
  end
end
